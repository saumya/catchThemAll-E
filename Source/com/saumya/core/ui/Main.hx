...
import com.saumya.catchThemAll.ApplicationView;
...
{
	private var application:ApplicationView;
	...
	private function onAddedToStage(e:Event):Void 
	{
		...
		this.application = new ApplicationView(this.stage.stageWidth,this.stage.stageHeight);
		this.construct();
	}
